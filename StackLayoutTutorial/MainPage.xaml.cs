...
using StackLayoutTutorial.Model;
using Xamarin.Forms;
...
namespace StackLayoutTutorial
{
    ...
    public partial class MainPage : ContentPage
    {
        ...
        void OnListViewItemSelected(object sender, Xamarin.Forms.SelectedItemChangedEventArgs e)
        {
            Monkey selectedItem = e.SelectedItem as Monkey;
        }

        void OnListViewItemTapped(object sender, Xamarin.Forms.ItemTappedEventArgs e)
        {
            Monkey tappedItem = e.Item as Monkey;
        }

        void OnEntryTextChanged(object sender, Xamarin.Forms.TextChangedEventArgs e)
        {
        ...
        void OnEditorTextChanged(object sender, Xamarin.Forms.TextChangedEventArgs e)
        {
            string oldText = e.OldTextValue;
            string newText = e.NewTextValue;
        }
